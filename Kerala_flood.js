...
var worldpop = ee.ImageCollection("WorldPop/GP/100m/pop_age_sex_cons_unadj"),
    kerala = ee.FeatureCollection("users/biman17/kerala_aoi_final");
...
var before_end='2018-07-20';

// Now set the same parameters for AFTER the flood.
var after_start='2018-08-07';
var after_end='2018-08-22';
...
var aoi = ee.FeatureCollection(kerala);
...
var after = after_collection.min().clip(aoi);
...
//Histogram plotting for difference image

// Define the chart and print it to the console.
var chart =
    ui.Chart.image.histogram({image: after_filtered, region: kerala, scale: 1000})
        .setOptions({
          title: 'SAR difference Histogram',
          hAxis: {
            title: 'Difference Backscatter (x1e4)',
...
//Threshold based on single image of flood event

var th = -16.5;
var difference_binary = after_filtered.lt(th);
...
// Refine flood result using additional datasets
      ...
      //Use Copernicus permanent water bodies to exclude from calculating flood areas
      // var copernicus_lulc = ee.Image("COPERNICUS/Landcover/100m/Proba-V-C3/Global/2018").select('discrete_classification');
      // var per_water_mask = copernicus_lulc.eq(80).updateMask(copernicus_lulc.eq(80));
      // Map.addLayer(copernicus_lulc, {}, "Land Cover");
      // Map.addLayer(swater, {},'Surface Water');

      
      //Flooded layer where perennial water bodies (water > 10 mo/yr) is assigned a 0 value
      var flooded_mask = difference_binary.where(swater_mask,0);
      
      // //Flooded layer where permanent water bodies is assigned a 0 value
      // var flooded_mask = difference_binary.where(per_water_mask,0);
...
var precip = CHIRPS.filterDate('2018-05-01','2018-09-30');

var precip1year=CHIRPS.filterDate('2020-01-01','2020-12-30');
var TS1 = ui.Chart.image.series(precip1year, aoi, ee.Reducer.mean(),1000, 'system:time_start').setOptions({
